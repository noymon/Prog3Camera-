...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    //בדיקה האם הדפדפן תומך בהפעלת מצלמת וידאו
    //קודם האם הוא תומך בפונקציית מדיה של המכשיר
    //ואז בודקים האם אפשר לקחת את הוידאו מתוך המכשיר
    if ('mediaDevices' in navigator && 'getUserMedia' in navigator.mediaDevices) {
        startVideo();
    } else {
        //במידה ולא נתמך, נדפיס לקונסול שהמצלמה לא נתמכת
...
//פונקציה א-סינכרונית בגלל שלוקח זמן עד שהוידאו מתחיל לפעול
...
//פונקציה שמטרתה להמיר את התמונה שיצרנו לקובץ
...
//פונקציה שתפעל בלחיצה על כפתור שיתוף. הפונקציה תקרא לפונקציה שממירה את התמונה לקובץ, תפעיל את אופציית השיתוף של הדפדפן ותשלח את הקובץ
function share() {
